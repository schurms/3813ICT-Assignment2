...
@Component({
  selector: 'app-chatroom-history',
  templateUrl: './chatroom-history.component.html',
  styleUrls: ['./chatroom-history.component.css']
})
export class ChatroomHistoryComponent implements OnInit {
